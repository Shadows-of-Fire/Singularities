...
public class RecipeHelper {
	...
	private static final String MODID = Singularities.MODID;
	private static final String MODNAME = Singularities.NAME;
	public static IForgeRegistry<IRecipe> registry = null;
	...
	public static void addRecipe(int j, IRecipe rec) {
		if (rec.getRegistryName() == null) registry.register(rec.setRegistryName(new ResourceLocation(MODID, "recipe" + j)));
	...
	public static void addRecipe(String name, IRecipe rec) {
		if (rec.getRegistryName() == null) registry.register(rec.setRegistryName(new ResourceLocation(MODID, name)));
		else registry.register(rec);
	}
